...
Final re-review correction: complete (single correction commit; 295 tests pass; DONE_WITH_CONCERNS for missing emulator tooling and unchanged lint baseline)
