...
const startIndex = lines.findIndex((l, index) => l.includes(targetLine) && lines[index - 1] && lines[index - 1].includes('<button'));
...
console.log('Inserting social links at line:', insertIndex + 1);

const linksBlock = `                {/* Social Links inside Popup */}
                <div className="flex flex-wrap justify-center gap-2 mt-4 mb-1">
                  <a href="https://instagram.com/rosary_plant_house" target="_blank" rel="noopener noreferrer" 
                     className="flex items-center justify-center p-2 bg-gradient-to-tr from-yellow-400 via-pink-500 to-purple-600 text-white rounded-full hover:scale-110 shadow-md transition-transform">
                  ...
                  <a href="https://facebook.com/rosaryplanthouse" target="_blank" rel="noopener noreferrer" 
                     className="flex items-center justify-center p-2 bg-[#1877F2] text-white rounded-full hover:scale-110 shadow-md transition-transform">
                  ...
                  <a href="https://wa.me/917904050237" target="_blank" rel="noopener noreferrer" 
                     className="flex items-center justify-center p-2 bg-[#25D366] text-white rounded-full hover:scale-110 shadow-md transition-transform">
...
lines.splice(insertIndex, 0, linksBlock);

fs.writeFileSync(filePath, lines.join('\n'), 'utf-8');
console.log('Social Links inserted in popup');
