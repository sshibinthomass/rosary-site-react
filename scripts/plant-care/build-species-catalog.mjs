...
const productsPath = path.resolve(repoRoot, 'src', 'data', 'products.json');
const outputPath = path.resolve(repoRoot, 'src', 'features', 'plantCare', 'data', 'species.generated.json');
